         ...
         <div class="col-md-2">&nbsp;
           ...
           <div class="col-md-8">
				...
				<section class="jumbotron text-center">
					<div class="container">
						<h3 class="jumbotron-heading">WELCOME TO Time Table</h3>
						<p class="lead text-muted">Select Type of User</p>
						<p>
							<a href="student/login.php" class="btn btn-primary my-2">Student</a>
							<a href="admin/login.php" class="btn btn-secondary my-2">Admin</a>
						</p>
					</div>
				</section>
