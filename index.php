       ...
       <div class="row">
         <div class="col-md-2">&nbsp;
           ...
           <div class="col-md-8">
				...
				<!--<center><h3>WELCOME TO COLLEGE ACADEMIC ACTIVITIES INCLUDING STUDENTS'S FEEDBACK</h3></center> -->
				
				<section class="jumbotron text-center">
					<div class="container">
						<h3 class="jumbotron-heading">WELCOME TO COLLEGE ACADEMIC ACTIVITIES INCLUDING STUDENT'S FEEDBACK</h3>
						<!--<p class="lead text-muted">Select Type of User</p>
						<p>
							<a href="#" class="btn btn-primary my-2">Student</a>
