  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="width:100%;margin:0 auto;">
      ...
      <div class="modal-body">
			...
			<?php 
			 $sqlss = mysql_query("select * from staff where staff_id='$id'");
			 $rowss = mysql_fetch_array($sqlss);
			 $idnum = $rowss['idnumber'];
				  $sqltd = mysql_query("select * from feedback where idnumber='$idnum' AND category='staff' ORDER BY feedback_id DESC");
