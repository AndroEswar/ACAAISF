<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "insert into workshoptl(title, spagency, wdate, tdate, days, role, type, userid, additionalinfo,place)values('$title','$agency','$cdate','$todate','$days','$role','$workshop',$user_check,'$addInfo','$place')";
      ...
      if($result == TRUE) {
         ...
         header("location: facultyworkshop.php?msg=successfully added");
      }else {
         $error = "Not inserted";
      }
   }
...
<div style = "font-size:11px; color:#cc0000; margin-top:10px"></div>
			    ...
			    <select  class="form-control" placeholder="Type of workshop" name="workshop">
