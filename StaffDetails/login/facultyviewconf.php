...
<html lang="en">
<head>
<title>Faculty Conferences </title>
<meta charset="UTF-8" />
          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
			   ...
			   <li class="active"><a href="facultyviewconf.php">Conferences</a></li>
...
<?php
   $user_check = $_SESSION['login_user'];
	$sql = "SELECT confid, agencyname, title, cdate, role, days, todate, additionalinfo, type FROM conferencestl where userid=$user_check";
