<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $worth = mysqli_real_escape_string($db,$_POST['worth']); 
	 
	   $addInfo = mysqli_real_escape_string($db,$_POST['addInfo']); 
	     $status = mysqli_real_escape_string($db,$_POST['status']); 
	 
	   
      $sql = "insert into researchtl(spagency, title, worth, sandate, status, additionalinfo,userid)values('$agency','$title','$worth','$cdate','$status','$addInfo',$user_check)";
      ...
      if($result == TRUE) {
         ...
         header("location: facultyresearch.php?msg=successfully added");
      }else {
         $error = "Not inserted";
      }
   }
...
<div style = "font-size:11px; color:#cc0000; margin-top:10px"></div>
			   ...
			   <input required type="text" class="form-control from-datepicker" placeholder="Sanction Date" name="cdate">
			   <input required type="text" class="form-control" placeholder="Price" name="worth">
