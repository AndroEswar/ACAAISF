<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $pdate = mysqli_real_escape_string($db,$_POST['pdate']); 
	   ...
	   $pageno = mysqli_real_escape_string($db,$_POST['pageno']); 
	     $valume = mysqli_real_escape_string($db,$_POST['valume']); 
		 $isbn = mysqli_real_escape_string($db,$_POST['isbn']); 
	     $issnno = mysqli_real_escape_string($db,$_POST['issnno']); 
		 
	 
	   
      $sql = "insert into journaltl( type, title, name, pdate, pageno, valume, isbn, issnno, userid)values('$type', '$title', '$name', '$pdate', '$pageno', '$valume', '$isbn', '$issnno',$user_check)";
      ...
      if($result == TRUE) {
         ...
         header("location: facultyjournals.php?msg=successfully added");
      }else {
         $error = "Not inserted";
		  echo $error;
      }
...
<div style = "font-size:11px; color:#cc0000; margin-top:10px"></div>
                ...
                <select  class="form-control" placeholder="Type of Journal" name="type">
				  ...
				  <input required type="text" class="form-control" placeholder="Title of Publication" name="title">
				    <input required type="text" class="form-control" placeholder="Name of Publication" name="name">
				 
			
			   <input required type="text" class="form-control from-datepicker" placeholder="Publication Date" name="pdate" >
			   <input required type="text" class="form-control" placeholder="Pagenos" name="pageno">
			     <input required type="text" class="form-control" placeholder="Valume of Publication" name="valume">
			    <input required type="text" class="form-control" placeholder="ISBN No" name="isbn">
				 <input required type="text" class="form-control" placeholder="ISSN NO" name="issnno">
