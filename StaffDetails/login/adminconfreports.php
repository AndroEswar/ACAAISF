              ...
              <ul class="nav navbar-nav navbar-right">
               ...
               <li><a href="admindept.php">Departments</a></li>
				...
				<li class="dropdown active">
				  ...
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminconfreports.php">Conferences </a></li>
					<li class="kopie"><a href="adminaresreports.php">Research Projects
...
<?php
   $user_check = $_SESSION['login_user'];
	$sql = "SELECT * FROM conferencestl c where date(cdate)>=date'2017-04-25' and date(todate)<=date'2017-05-16'";
