    ...
    if (deptId == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("txtHintFac").innerHTML = this.responseText;
            }
        };
		
        xmlhttp.open("GET","getfacid.php?deptId="+deptId,true);
        xmlhttp.send();
    }
}
</script>
...
function showFacReport() {
    ...
    if (facId == "") {
        ...
        xmlhttp.open("GET","getfacultyreports.php?facId="+facId+"&fdate="+fdate+"&tdate="+tdate,true);
        xmlhttp.send();
    }
}
</script>
...
<div class="row register">
 ...
 <div style = "font-size:11px; color:#cc0000; margin-top:10px"></div>
   ...
   <input required type="text" class="form-control from-datepicker" placeholder="From Date" name="fdate" id="fdate">
               ...
               <select onchange="showFac()"  name="deptId" id="deptId" required class="form-control">
